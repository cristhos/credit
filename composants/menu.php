                    ...
                    <ul class="nav navbar-nav pull-right">
                            ...
                            <?php if ($_SESSION['numero']){
                                        echo'<li class="dropdown">
                                            <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">'.$_SESSION['nom_complet'].'<span class="caret"></span></a>
                                            <ul class="dropdown-menu">
                                                <li><a href="">'.$_SESSION['numero'].'</a></li>
